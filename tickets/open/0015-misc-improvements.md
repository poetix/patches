...
### SampleBuffer write_index as bool (clarity)
- [ ] `SampleBuffer::write_index` is `bool` instead of `usize`, using `as usize` for array indexing — makes the toggle semantics explicit
